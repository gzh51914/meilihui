<template>
  <div>
      ...
      <div class="nav">
        <span>满折</span><span>焕新日女装一件8折</span><br>
...
export default {
  ...
  created () {
    instance.get(`/appapi/event/product/v3?pageIndex=1&categoryId=${this.$route.params.id}&key=&sort=&timestamp=1586529185323&summary=cf5fbcbe4e5acc177b8304a5a0b2a8b4&platform_code=H5`).then(res => {
