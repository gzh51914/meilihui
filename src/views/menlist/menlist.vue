...
export default {
  ...
  created () {
    instance
      .get(
        `/appapi/event/product/v3?pageIndex=1&categoryId=${this.$route.params.id}&key=&sort=&timestamp=1586523108522&summary=f4628ff981f13e81083e8f3bea58f37e&platform_code=H5
`
      )
      .then(res => {
